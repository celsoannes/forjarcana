...
$pagina_atual = $_GET['pagina'] ?? 'dashboard';
$acao = $_GET['acao'] ?? '';
$id = $_GET['id'] ?? '';
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="dist/img/logo-128x128.png" alt="Logo Forjarcana" height="60" width="60">
  </div>
    ...
    <div class="sidebar">
        ...
        <div class="info">
          <a href="#" class="d-block">
            <?php
              ...
              $sobrenome = isset($_SESSION['usuario_sobrenome']) ? $_SESSION['usuario_sobrenome'] : '';
              echo htmlspecialchars(trim($nome . ' ' . $sobrenome)) ?: 'Usuário';
            ?>
          </a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Sessão ADMINISTRAÇÃO só para admin -->
  ...
  <div class="content-wrapper">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">
                <?= getBreadcrumbPagina($pagina_atual); ?>
              </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
    ...
    <section class="content">
      <div class="container-fluid">
        <?php require_once __DIR__ . '/app/router.php'; ?>
      </div>
    </section>
    <!-- /.content -->
  </div>
