...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK && $usuario_uuid) {
    // Salva em uploads/usuarios/{uuid} com prefixo 'filamento'
    $caminhoCapa = uploadImagem($_FILES['foto'], $usuario_uuid, 'usuarios', null, 'filamento');
  }
  $resultadoFluxo = $filamentoController->processarFluxoAdicao((int) $usuario_id, $_POST, $caminhoCapa);
...
<div class="card card-primary">
  <div class="card-header">
    <h3 class="card-title">Adicionar Filamento</h3>
  </div>
