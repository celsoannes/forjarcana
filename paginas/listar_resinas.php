...
<a href="?pagina=resinas&acao=adicionar" class="btn btn-adicionar mb-3">Adicionar Resina</a>
    ...
    <tbody>
        <?php foreach ($resinas as $resina): ?>
            <tr>
                ...
                <td>
                    <a href="?pagina=resinas&acao=editar&id=<?= $resina['id'] ?>" class="btn btn-sm btn-editar">Editar</a>
                    <a href="#"
