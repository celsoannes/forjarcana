...
<?php if (empty($registros)): ?>
    <a href="?pagina=energia&acao=adicionar" class="btn btn-adicionar mb-3">Adicionar custo de energia elétrica</a>
        ...
        <tbody>
            <?php foreach ($registros as $r): ?>
                <tr>
                    ...
                    <td>
                        <a href="?pagina=energia&acao=editar&id=<?= $r['id'] ?>" class="btn btn-sm btn-editar">Editar</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
