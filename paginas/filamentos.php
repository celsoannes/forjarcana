...
<a href="?pagina=adicionar_filamento" class="btn btn-adicionar mb-3">Adicionar Filamento</a>
    ...
    <tbody>
        <?php foreach ($filamentos as $filamento): ?>
            <tr>
                ...
                <td>
                    <a href="?pagina=editar_filamento&id=<?= $filamento['id'] ?>" class="btn btn-sm btn-editar">Editar</a>
                    <a href="#"
