...
<a href="?pagina=usuarios&acao=adicionar" class="btn btn-adicionar mb-3">Adicionar Usuário</a>
    ...
    <tbody>
        <?php foreach ($usuarios as $usuario): ?>
            <tr>
                ...
                <td>
                    <a href="?pagina=usuarios&acao=editar&id=<?= $usuario['id'] ?>" class="btn btn-sm btn-editar">Editar</a>
                    <a href="#"
